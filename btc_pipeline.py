...
def run():
    ...
    # Flag = 1 quand mvrvPct < 15% (calibré sur données CQ : ratio réel < 6)
    # Validé sur fonds 2015, 2018, 2020-mars, 2022-déc
    utxo_flag = 1 if utxo_val < 15.0 else 0
    ...
    print(f"  UTXO proxy(mvrvPct)={dashboard['utxoRatio']:.2f}%  Flag={dashboard['utxoFlag']}  (Flag si <15%)")
