...
def run():
    ...
    # Flag = 1 quand ratio P/L < 3 (valeur CQ réelle)
    # Notre proxy : utxo_val × 711 ≈ ratio réel → flag si utxo_val × 711 < 3
    utxo_flag = 1 if utxo_val * 711 < 3.0 else 0
    ...
    dashboard = {
        ...
        "utxoRatio":        round(utxo_val, 6),   # Ratio [proxy]
        "utxoSma365":       round(utxo_val * 711, 2),  # SMA-365d proxy (×711 échelle CQ)
